<?php
  ...
  try {
    ...
    $tsql = "SELECT t1.*,t2.*,t4.descripcion as nombreTipoVehiculo,t3.descripcion as nombrePromocion,t5.descripcion as nombreMoneda,
              ...
              LEFT JOIN d_seguros as t13 ON t13.tipo_seguro = t1.tipo_vehiculo_a_comprar AND t13.id_tipovehiculo = t2.tipovehiculo AND t13.id_usoseguro = t1.id_uso AND ((YEAR(NOW()) - t1.anno) >= t13.rango_inferior AND (YEAR(NOW()) - t1.anno) <= t13.rango_superior)
