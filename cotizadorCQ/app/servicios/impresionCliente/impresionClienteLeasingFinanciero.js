...
.factory("impresionClienteLeasingFinancieroService", function(crediqLeasing, calcularFormulasService) {
  var factory = {};
  var datos = {};
  ...
  function format(n, currency) {
	...
	factory.impresionClienteLeasingFinancieroPDF = function(detalle, extrasCotizacion, extrasPromocion) {
    ...
    if(extrasCotizacion.length == 0 && extrasPromocion.length == 0){
      ...
      if(extrasCotizacion.length > 0){
        for(i = 0; i < extrasCotizacion.length; i++){
          ...
          extra.moneda = extrasCotizacion[i].moneda;
