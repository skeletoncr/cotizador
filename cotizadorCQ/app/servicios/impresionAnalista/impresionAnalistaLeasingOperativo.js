...
.factory("impresionAnalistaLeasingOperativoService", function(crediqLeasing, calcularFormulasService) {
  var factory = {};
  var datos = {};
  ...
  function format(n, currency) {
	...
	factory.impresionAnalistaLeasingOperativaPDF = function(detalle, extrasCotizacion, extrasPromocion) {
