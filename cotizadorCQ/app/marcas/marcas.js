...
/* @ngInject */
function MarcasController($scope, $rootScope, loading, $location, $http, $q, filterFilter) {
  ...
  function deleteMarca(id) {
    ...
    $http.post("app/marcas/php/deleteMarca.php", {id: id})
      .success(function(data){
...
MarcasController.$inject = ['$scope', '$rootScope', 'loading', '$location', '$http', '$q', 'filterFilter'];
