angular
  .module("Cotizador")
  .controller('DetalleVendedorController', DetalleVendedorController);

/* @ngInject */
function DetalleVendedorController($scope, $rootScope, $location, $http, $routeParams, $q, 
...
DetalleVendedorController.$inject = ['$scope', '$rootScope', '$location', '$http', '$routeParams', '$q', 'calcularFormulasService', 'correoService', 'impresionClienteService', 'impresionAnalistaService', '$crypto', 'impresionClienteLeasingOperativoService', 'impresionClienteLeasingFinancieroService'];
