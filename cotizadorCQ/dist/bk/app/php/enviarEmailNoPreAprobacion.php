<?php
  ...
  $data->cartaNoPreAprobacion;  // to access cartaNoPreAprobacion
  $nombrearch = 'cotizacion.pdf';
  $nombreCarta = 'CartaCrediQ.pdf';
  ...
  $descodificadoPreAprobacion = base64_decode($data->cartaNoPreAprobacion);
  $mail->AddStringAttachment($descodificadoPreAprobacion,$nombreCarta,'base64');
