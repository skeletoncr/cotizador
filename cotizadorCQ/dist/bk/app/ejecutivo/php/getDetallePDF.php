<?php
  ...
  $data->usoSeguro; // to access usoSeguro

  $m_db;
  $output = null; // Json Array
  try {
    /* Get Query.*/
    $tsql = "SELECT t1.descripcion as nombrePromocion,
                  t2.*,
                  t3.cambio_dolar, t3.cambio_dolar_seguros,
                  t4.descripcion as nombreTipoVehiculo,
                  t5.descripcion as nombreMoneda,
                  ...
                  t8.codigo as seccionCodigo, t8.descripcion as seccionDescripcion, t8.porcentaje as prima,
                  t13.a, t13.b, t13.c, t13.d, t13.f, t13.g, t13.h
              FROM d_promociones as t1
              LEFT JOIN d_marcas_modelos as t2 ON trim(t2.modelo) = trim('" .$data->modelo ."')
              LEFT JOIN d_variables as t3 ON t3.id = 1
              LEFT JOIN d_tipovehiculo as t4 ON t4.id = t2.tipovehiculo
              LEFT JOIN d_monedas as t5 ON t5.id = " . $data->moneda ."
              LEFT JOIN d_promociones_detalles as t7 ON t7.id_promocion = t1.id
              ...
              LEFT JOIN d_seguros as t13 ON t13.tipo_seguro = " . $data->tipo_seguro . " AND t13.id_tipovehiculo = t2.tipovehiculo AND t13.id_usoseguro = " . $data->usoSeguro . " AND ( (YEAR(NOW()) - " . $data->annio .") >= t13.rango_inferior AND (YEAR(NOW()) -" . $data->annio .") <= t13.rango_superior)
    ...
    error_log("DetallePDF::get: Exception=" . $e->getMessage());
