angular
  .module("Cotizador")
  .controller('BandejaAdministradorController', BandejaAdministradorController)
...
/* @ngInject */
function BandejaAdministradorController($scope, $rootScope, loading, $location, $http, localStorageService, filterFilter) {
...
BandejaAdministradorController.$inject = ['$scope', '$rootScope', 'loading', '$location', '$http', 'localStorageService', 'filterFilter'];
