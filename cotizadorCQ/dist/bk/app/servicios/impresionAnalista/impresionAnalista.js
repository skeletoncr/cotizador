...
.factory("impresionAnalistaService", function(crediq, calcularFormulasService) {
  var factory = {};
  var datos = {};
  ...
  function format(n, currency) {
	...
	factory.impresionAnalistaPDF = function(detalle, extrasCotizacion, extrasPromocion) {
    ...
    datos.saldoVehiculo = detalle.preciocongastos - datos.primaValor;
    ...
    var docDefinition = {
      content: [
        ...
        {
          text: datos.nombreBonificacion + detalle.bonificacionSeguro,
          fontSize: 7,
          bold: true,
          margin: [75, -10, 0, 15]
        },
