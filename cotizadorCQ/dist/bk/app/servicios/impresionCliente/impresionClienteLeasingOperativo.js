...
.factory("impresionClienteLeasingOperativoService", function(crediqLeasing, calcularFormulasService) {
  var factory = {};
  var datos = {};
  ...
  function format(n, currency) {
	...
	factory.impresionClienteLeasingOperativoPDF = function(detalle, extrasCotizacion, extrasPromocion) {
    ...
    if(detalle.seguroMensual != -1){
      datos.seguroMensual = detalle.seguroMensual;
    }
    ...
    var bodyConExtras = [
                ...
                [ 'Deposito de garantia:', {text: format(parseFloat(datos.primaValor), ''),alignment:'right'}, {text: datos.porcentajePrima+'%', alignment:'center'} ],
    ...
    var docDefinition = {
      content: [
        ...
        {
          text: 'En atención a su estimable solicitud de arrendamiento, ' 
